...
export const routes: Routes = [
  ...
  { path: 'freelancer/job-detail/:id', loadComponent: () => import('./pages/freelancer/job-detail/job-detail.page').then(m => m.JobDetailPage) },
  { path: 'freelancer/apply-job/:id', loadComponent: () => import('./pages/freelancer/apply-job/apply-job.page').then(m => m.ApplyJobPage) },
